...
public class paukScript : MonoBehaviour {
    ...
    private void FixedUpdate()
    {
        ...
        if (isGrounded == true)
        {
            ...
            playerDistance = Mathf.Sqrt(((paukX - playerX) * (paukX - playerX)) + ((paukY - playerY) * (paukY - playerY)));
            ...
            if (playerDistance < 15 && ima.imaPauka == "")
            {
                if (playerX < paukX)
